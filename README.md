...
**Running the program** - To run the program simply download the project from this github page. After you completed the download add it as a new project in your prefered python IDE. Then access the main class and modify it to run which graph and algorithms you want. There is json files added to this git so you have built in graphs to test the implmentation.
